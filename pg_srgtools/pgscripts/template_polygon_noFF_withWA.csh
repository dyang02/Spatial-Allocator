...
printf "\t${weight_attribute}_dens_${srid_final} double precision default 0.0,\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
printf "update  ${schema_name}.wp_cty_${surg_code}_${srid_final} set\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "\t${weight_attribute}=${weight_attribute}_dens_${srid_final} * area_${srid_final};\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
